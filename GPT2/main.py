...
if not os.path.exists("input.txt"):
    req = requests.get(
        r"https://raw.githubusercontent.com/b1zantine/thirukkural-dataset/master/thirukkural.txt",
        verify=False,
    )
...
class Head(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # compute the attention scores ("affinities") -> which is the strong connection between the tokens
